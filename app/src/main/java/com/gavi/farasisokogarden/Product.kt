...
class ProductAdapter(private val productList: List<Product>) : // diplays a list of products
    ...
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        //Change/Replaced modcom2 below to my Python Anywhere username
        val imageUrl = "https://gavi.alwaysdata.net/static/images/${product.product_photo}"
        ...
        holder.btnPurchase.setOnClickListener {
            ...
            val intent = android.content.Intent(context, Payments::class.java).apply {
                putExtra("product_id", product.product_id) // put extra - takes a product from one component to another
